...
**Stanford redirect:** Upload everything under `stanford-www/` to your Stanford `WWW` folder (replacing the old static mirror) so `https://web.stanford.edu/~asinghvi/` sends visitors to this GitHub Pages site.
